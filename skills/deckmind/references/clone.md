...
Establish which DeckMind checkout will be used for setup and runtime actions.

## Procedure

1. Check whether DeckMind already exists locally.
...
```bash
git clone https://github.com/THU-MAIC/DeckMind.git
cd DeckMind
```
